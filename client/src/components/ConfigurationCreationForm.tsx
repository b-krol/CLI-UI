...
export default function ConfigurationCreationForm() {
  ...
  const [mongodbUseConnectionString, setMongodbUseConnectionString] = useState(
    mongodbUseConnectionStringDefaultChecked
  );
      ...
      {(selectedDatabaseEngine === "mysql" ||
        ...
        <Form fluid>
          <Form.Group controlId="mysqlORpostgresqlHostAdressInput">
            ...
            <Form.Control name="mysqlORpostgresqlHostAdress" accepter={Input} />
            <Form.HelpText tooltip>
          ...
          <Form.Group controlId="mysqlORpostgresqlPasswordInput">
            ...
            <InputGroup>
              ...
              <InputGroup.Addon>
                ...
                >
                  {visibleDatabasePassword ? <VisibleIcon /> : <EyeCloseIcon />}
                </InputGroup.Button>
              </InputGroup.Addon>
            </InputGroup>
            <Form.HelpText tooltip>
